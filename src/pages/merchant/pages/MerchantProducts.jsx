...
const MerchantProducts = ({ onNav }) => (
  <div className="animate-[fadeUp_0.4s_ease_both]">
    <MerchantPageHeader title="My" highlight="Products" subtitle="Manage all your product listings" />
        ...
        <table className="w-full">
          ...
          <tbody>
            {products.map((p) => (
              ...
              >
                <td className="px-4 py-3 text-[0.875rem] text-white">{p.name}</td>
                <td className="text-gray px-4 py-3 text-[0.875rem]">{p.sku}</td>
                <td className="px-4 py-3 text-[0.875rem] text-white">{p.price}</td>
                ...
                <td className="px-4 py-3 text-[0.875rem] text-white">{p.sales}</td>
                <td className="text-teal px-4 py-3 text-[0.875rem] font-medium">{p.rev}</td>
                <td className="px-4 py-3">
